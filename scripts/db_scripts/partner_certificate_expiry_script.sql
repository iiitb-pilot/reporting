SELECT P.ISSUER_ID, SPLIT_PART(SPLIT_PART(P.CERT_SUBJECT, ',', 1),'=',2) AS COMMON_NAME, P.ORGANIZATION_NAME, P.PARTNER_DOMAIN, TO_CHAR(P.CERT_NOT_AFTER, 'DD/MON/YYYY') AS PARTNER_EXPIRY_ON,
